...
# Configure CORS - Allow requests from your GitHub Pages domain
CORS(app, resources={
    r"/api/*": {
        "origins": ["http://katzu.org", "http://www.katzu.org"],  # Update with your actual domain: ["https://yourusername.github.io"]
